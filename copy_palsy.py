...
PALSY_SET = DATASET_ROOT / "Palsy Set"
OUTPUT_DIR = PALSY_SET / "Subjects"

SOURCE_SETS = [
    PALSY_SET / "Image" / "Image",
    PALSY_SET / "Image2" / "Image2",
    PALSY_SET / "Image3" / "Image3",
    PALSY_SET / "Image4" / "Image4",
]
...
def main():
    ...
    for current, subject_folder in enumerate(subject_folders, start=1):
        ...
        if not images:
            print(
                f"\nWarning: {subject_folder} contains no supported images. "
                "Skipping."
            )
            skipped_count += 1
